...
struct ImageProcessorConfig {
  ...
  bool validate() const {
    ...
    static const std::set<std::string> valid_formats = {"RGB888", "RGB565", "YUV422", "GRAYSCALE", "JPEG"};
...
class ImageProcessor {
 ...
 private:
  ...
  bool process_rgb888_crop_and_scale_to_uint8(const uint8_t *input_data, const CropZone &zone, int crop_width,
                                              int crop_height, uint8_t *output_buffer, int model_width,
                                              int model_height, int model_channels);
  ...
  // Scaling functions
  bool scale_rgb888_to_float32(const uint8_t *input_data, int input_width, int input_height, uint8_t *output_buffer,
                               int output_width, int output_height, int output_channels, bool normalize);

  bool scale_rgb888_to_uint8(const uint8_t *input_data, int input_width, int input_height, uint8_t *output_buffer,
  ...
  void debug_log_float_image(const float *data, size_t count, int width, int height, int channels,
  ...
  void debug_analyze_processed_zone(const uint8_t *data, int width, int height, int channels,
                                    const std::string &zone_name);

  void debug_output_zone_preview(const uint8_t *data, int width, int height, int channels,
                                 const std::string &zone_name);

  void debug_analyze_float_zone(const float *data, int width, int height, int channels, const std::string &zone_name,
                                bool normalized);

  void debug_output_float_preview(const float *data, int width, int height, int channels, const std::string &zone_name,
                                  bool normalized);
