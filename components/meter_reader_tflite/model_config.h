...
static const std::unordered_map<std::string, ModelConfig> MODEL_CONFIGS = {
    ...
    {"digit_recognizer_v4_10cls_RGB", 
        ModelConfig{
            ...
            .tensor_arena_size = "110KB", //check_tflite_model.py reports : Total Arena Size: 103.02 KB
    ...
    {"digit_recognizer_v17_10cls_RGB", 
        ModelConfig{
            .description = "digit_recognizer_v17_10cls_RGB",
            .tensor_arena_size = "175KB", //check_tflite_model.py reports : Total Arena Size: 174.11 KB
            .output_processing = "direct_class", //qat_quantized, auto_detect
            .scale_factor = 1.0f,
            .input_type = "uint8",  
            .input_channels = 3,
    ...
    {"digit_recognizer_v16_10cls_RGB", 
        ModelConfig{
            .description = "digit_recognizer_v16_10cls_RGB",
            .tensor_arena_size = "250KB", //check_tflite_model.py reports : Total Arena Size: 246.28 KB
            .output_processing = "direct_class", //qat_quantized, auto_detect
            .scale_factor = 1.0f,
            .input_type = "uint8",  
            .input_channels = 3,
    ...
    {"digit_recognizer_v23_10cls_RGB", 
        ModelConfig{
            .description = "digit_recognizer_v23_10cls_RGB",
            .tensor_arena_size = "85KB", //check_tflite_model.py reports : Total Arena Size: 81.61 KB
            .output_processing = "direct_class", //qat_quantized, auto_detect
            .scale_factor = 1.0f,
            .input_type = "uint8",  
            .input_channels = 3,
