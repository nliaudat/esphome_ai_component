...
static const std::unordered_map<std::string, ModelConfig> MODEL_CONFIGS = {
    ...
    {"mnist", ModelConfig{.description = "MNIST Digit Classifier",
    ...
    // .tensor_arena_size = "130KB", //check_tflite_model.py reports : Total Arena Size: 101.21 KB (doubling the model
    // size seems to be validated in my tests) .output_processing = "softmax", .scale_factor = 1.0f, .input_type =
    // "uint8", .input_channels = 1, .input_order = "RGB", .input_size = {32, 20}, .normalize = false
    // }
    // },
    {"digit_recognizer_v4_10cls_RGB",
     ModelConfig{.description = "digit_recognizer_v4_10cls_RGB",
    ...
    {"digit_recognizer_v3_10cls_RGB",
     ModelConfig{.description = "digit_recognizer_v3_10cls_RGB",
